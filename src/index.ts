...
eyeInput?.addEventListener("click", () => {
	...
	eyeInput.className = `fa-solid fa-eye${
...
passInput.addEventListener("keyup", (event) => {
	...
	requirements.forEach((item) => {
		...
		const requirementItem = requirementsList[item.index] as HTMLElement;
		if (isValid) {
